...
class _$_WeatherModel implements _WeatherModel {
  const _$_WeatherModel({required this.visibility});
  ...
  @override
  String toString() {
    return 'WeatherModel(visibility: $visibility)';
  }
...
abstract class _WeatherModel implements WeatherModel {
  const factory _WeatherModel({required final int visibility}) =
      _$_WeatherModel;
